...
//variables fof sound or tetris functions


var DROP_SOUND = new buzz.sound([
    "Resources/Tetris/sound/drop.ogg",
    "Resources/Tetris/sound/drop.mp3" 
]);

var LINE_SOUND = new buzz.sound([
    "Resources/Tetris/sound/line.ogg",
    "Resources/Tetris/sound/line.mp3" 
]);

var TETRIS_SOUND = new buzz.sound([
    "Resources/Tetris/sound/tetris.ogg",
    "Resources/Tetris/sound/tetris.mp3" 
]);
var MOVE_SOUND = new buzz.sound([
    "Resources/Tetris/sound/move.ogg",
    "Resources/Tetris/sound/move.mp3" 
]);
var ROTATE_SOUND = new buzz.sound([
    "Resources/Tetris/sound/rotate.ogg",
    "Resources/Tetris/sound/rotate.mp3" 
]);
var GAMEOVER_SOUND = new buzz.sound([
    "Resources/Tetris/sound/gameover.ogg",
    "Resources/Tetris/sound/gameover.mp3" 
]);
var THEME_SOUND = new buzz.sound([
    "Resources/Tetris/sound/theme.ogg",
    "Resources/Tetris/sound/theme.mp3" 
]);
